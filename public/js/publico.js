...
socket.on('estado-actual', (payload) => {
    ...
    if(ticket1){
        ...
        lblTicket1.innerText = 'Aun no hay actividad';
    }
    if(ticket2){
        ...
        lblTicket2.innerText = 'Aun no hay actividad';
    }
    if(ticket3){
        ...
        lblTicket3.innerText = 'Aun no hay actividad';
    }
    if(ticket4){

        lblTicket4.innerText = 'Ticket ' + ticket4.numero;
        lblEscritorio4.innerText = ticket2.escritorio;
    }else{
        lblTicket4.innerText = 'Aun no hay actividad';
    }
});